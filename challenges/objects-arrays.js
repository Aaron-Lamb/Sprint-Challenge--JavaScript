...
*/
const lowPopulationAnimals = zooAnimals.filter((lownumbers) => lownumbers.population < 5);
...
*/
const populationTotal = zooAnimals.reduce((acc, uspopulation) => acc + uspopulation.population, 0);
